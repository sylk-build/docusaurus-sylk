...
exports.SylkPackage = {
    ...
    fromJSON(object) {
        return {
            services: Array.isArray(object === null || object === void 0 ? void 0 : object.services) ? object.services.map((e) => SylkService_1.SylkService.fromJSON(e)) : [],
    ...
    toJSON(message) {
        const obj = {};
        if (message.services) {
            obj.services = message.services.map((e) => e ? SylkService_1.SylkService.toJSON(e) : undefined);
        }
        else {
            obj.services = [];
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseSylkPackage();
        message.services = ((_a = object.services) === null || _a === void 0 ? void 0 : _a.map((e) => SylkService_1.SylkService.fromPartial(e))) || [];
        message.messages = ((_b = object.messages) === null || _b === void 0 ? void 0 : _b.map((e) => SylkMessage_1.SylkMessage.fromPartial(e))) || [];
        ...
        message.enums = ((_f = object.enums) === null || _f === void 0 ? void 0 : _f.map((e) => SylkEnum_1.SylkEnum.fromPartial(e))) || [];
