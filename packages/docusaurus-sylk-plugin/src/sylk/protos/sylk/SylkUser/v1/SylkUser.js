...
exports.SylkUser = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.orgsIds).forEach(([key, value]) => {
            exports.SylkUser_OrgsIdsEntry.encode({ key: key, value }, writer.uint32(90).fork()).ldelim();
        });
        if (message.locale !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 11:
                    ...
                    const entry11 = exports.SylkUser_OrgsIdsEntry.decode(reader, reader.uint32());
    ...
    fromJSON(object) {
        return {
            ...
            orgsIds: isObject(object.orgsIds)
                ? Object.entries(object.orgsIds).reduce((acc, [key, value]) => {
    ...
    fromPartial(object) {
        ...
        message.orgsIds = Object.entries((_b = object.orgsIds) !== null && _b !== void 0 ? _b : {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
                acc[key] = value;
            }
            return acc;
...
//# sourceMappingURL=SylkUser.js.map