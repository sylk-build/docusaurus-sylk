...
exports.SylkMessage = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.inlines) {
    ...
    fromJSON(object) {
        return {
            ...
            inlines: Array.isArray(object === null || object === void 0 ? void 0 : object.inlines) ? object.inlines.map((e) => any_1.Any.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.inlines) {
            obj.inlines = message.inlines.map((e) => e ? any_1.Any.toJSON(e) : undefined);
        }
        else {
            obj.inlines = [];
        }
    ...
    fromPartial(object) {
        ...
        message.inlines = ((_l = object.inlines) === null || _l === void 0 ? void 0 : _l.map((e) => any_1.Any.fromPartial(e))) || [];
        return message;
    },
};
