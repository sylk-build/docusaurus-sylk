...
const SylkClient_1 = require("../../SylkClient/v1/SylkClient");
const SylkServer_1 = require("../../SylkServer/v1/SylkServer");
...
exports.SylkProject = {
    ...
    fromJSON(object) {
        return {
            ...
            extensions: Array.isArray(object === null || object === void 0 ? void 0 : object.extensions) ? object.extensions.map((e) => any_1.Any.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.clients = ((_f = object.clients) === null || _f === void 0 ? void 0 : _f.map((e) => SylkClient_1.SylkClient.fromPartial(e))) || [];
        message.server = (object.server !== undefined && object.server !== null)
            ? SylkServer_1.SylkServer.fromPartial(object.server)
            : undefined;
        message.packageName = (_g = object.packageName) !== null && _g !== void 0 ? _g : "";
        message.extensions = ((_h = object.extensions) === null || _h === void 0 ? void 0 : _h.map((e) => any_1.Any.fromPartial(e))) || [];
        return message;
    },
};
...
exports.SylkProjectDisplay = {
    ...
    fromPartial(object) {
        ...
        message.members = Object.entries((_e = object.members) !== null && _e !== void 0 ? _e : {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
                acc[key] = value;
            }
            return acc;
