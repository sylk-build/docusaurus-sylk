...
exports.SylkTemplateConfigs = {
    ...
    fromJSON(object) {
        return {
            include: Array.isArray(object === null || object === void 0 ? void 0 : object.include) ? object.include.map((e) => String(e)) : [],
            exclude: Array.isArray(object === null || object === void 0 ? void 0 : object.exclude) ? object.exclude.map((e) => String(e)) : [],
    ...
    fromPartial(object) {
        ...
        const message = createBaseSylkTemplateConfigs();
        message.include = ((_a = object.include) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        message.exclude = ((_b = object.exclude) === null || _b === void 0 ? void 0 : _b.map((e) => e)) || [];
...
function createBaseSylkProjectConfigs() {
    return { description: "", host: "", template: undefined, port: 0, currentVersion: "", plugins: [] };
}
exports.SylkProjectConfigs = {
    ...
    fromJSON(object) {
        return {
            ...
            plugins: Array.isArray(object === null || object === void 0 ? void 0 : object.plugins) ? object.plugins.map((e) => String(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.plugins = ((_e = object.plugins) === null || _e === void 0 ? void 0 : _e.map((e) => e)) || [];
        return message;
    },
};
...
exports.SylkCliConfigs = {
    ...
    fromJSON(object) {
        return {
            sylkTemplates: Array.isArray(object === null || object === void 0 ? void 0 : object.sylkTemplates) ? object.sylkTemplates.map((e) => String(e)) : [],
            port: isSet(object.port) ? Number(object.port) : 0,
    ...
    fromPartial(object) {
        var _a, _b, _c, _d, _e, _f, _g;
        const message = createBaseSylkCliConfigs();
        message.sylkTemplates = ((_a = object.sylkTemplates) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        ...
        message.plugins = ((_g = object.plugins) === null || _g === void 0 ? void 0 : _g.map((e) => e)) || [];
        return message;
    },
};
...
//# sourceMappingURL=SylkConfigs.js.map