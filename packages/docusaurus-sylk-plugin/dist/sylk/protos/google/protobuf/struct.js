...
exports.Struct = {
    encode: function (message, writer) {
        ...
        Object.entries(message.fields).forEach(function (_g) {
            var key = _g[0], value = _g[1];
            if (value !== undefined) {
    ...
    fromJSON: function (object) {
        return {
            fields: isObject(object.fields)
                ? Object.entries(object.fields).reduce(function (acc, _g) {
                    var key = _g[0], value = _g[1];
                    acc[key] = value;
                    return acc;
                }, {})
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseStruct();
        message.fields = Object.entries((_a = object.fields) !== null && _a !== void 0 ? _a : {}).reduce(function (acc, _g) {
            var key = _g[0], value = _g[1];
            if (value !== undefined) {
                acc[key] = value;
            }
...
exports.ListValue = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        for (var _i = 0, _g = message.values; _i < _g.length; _i++) {
            var v = _g[_i];
