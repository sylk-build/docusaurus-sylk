...
exports.EncodedPagination = {
    ...
    decode: function (input, length) {
        ...
        var message = createBaseEncodedPagination();
...
exports.ActivityLog = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseActivityLog();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.PaginationResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBasePaginationResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.GetActivityLogsResponse = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        for (var _i = 0, _h = message.logs; _i < _h.length; _i++) {
            var v = _h[_i];
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseGetActivityLogsResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON: function (object) {
        return {
            logs: Array.isArray(object === null || object === void 0 ? void 0 : object.logs) ? object.logs.map(function (e) { return exports.ActivityLog.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        var obj = {};
        if (message.logs) {
            obj.logs = message.logs.map(function (e) { return e ? exports.ActivityLog.toJSON(e) : undefined; });
        }
        else {
            obj.logs = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseGetActivityLogsResponse();
        message.logs = ((_a = object.logs) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.ActivityLog.fromPartial(e); })) || [];
...
exports.PaginationRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBasePaginationRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.ListActivityLogsRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseListActivityLogsRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
