...
exports.SylkOneOfField = {
    ...
    decode: function (input, length) {
        ...
        var message = createBaseSylkOneOfField();
...
exports.SylkField = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _r = message.oneofFields; _i < _r.length; _i++) {
            var v = _r[_i];
        ...
        Object.entries(message.extensions).forEach(function (_r) {
            var key = _r[0], value = _r[1];
            if (value !== undefined) {
                exports.SylkField_ExtensionsEntry.encode({ key: key, value: value }, writer.uint32(114).fork()).ldelim();
            }
        });
        if (message.index !== 0) {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSylkField();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 11:
                ...
                case 14:
                    ...
                    var entry14 = exports.SylkField_ExtensionsEntry.decode(reader, reader.uint32());
    ...
    fromJSON: function (object) {
        return {
            ...
            oneofFields: Array.isArray(object === null || object === void 0 ? void 0 : object.oneofFields)
                ? object.oneofFields.map(function (e) { return exports.SylkOneOfField.fromJSON(e); })
                : [],
            name: isSet(object.name) ? String(object.name) : "",
            description: isSet(object.description) ? String(object.description) : "",
            enumType: isSet(object.enumType) ? String(object.enumType) : "",
            ...
            extensions: isObject(object.extensions)
                ? Object.entries(object.extensions).reduce(function (acc, _r) {
                    var key = _r[0], value = _r[1];
                    acc[key] = value;
                    return acc;
                }, {})
    ...
    toJSON: function (message) {
        ...
        if (message.oneofFields) {
            obj.oneofFields = message.oneofFields.map(function (e) { return e ? exports.SylkOneOfField.toJSON(e) : undefined; });
        }
        else {
            obj.oneofFields = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.oneofFields = ((_c = object.oneofFields) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.SylkOneOfField.fromPartial(e); })) || [];
        ...
        message.extensions = Object.entries((_l = object.extensions) !== null && _l !== void 0 ? _l : {}).reduce(function (acc, _r) {
            var key = _r[0], value = _r[1];
            if (value !== undefined) {
                acc[key] = value;
            }
...
exports.SylkField_ExtensionsEntry = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSylkField_ExtensionsEntry();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.SylkFieldDisplay = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : minimal_1.default.Reader.create(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSylkFieldDisplay();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 2:
