...
exports.SylkFileContext = {
    ...
    fromPartial: function (object) {
        ...
        message.code = (_b = object.code) !== null && _b !== void 0 ? _b : Buffer.alloc(0);
        message.methods = ((_c = object.methods) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.SylkMethodContext.fromPartial(e); })) || [];
        return message;
    },
};
