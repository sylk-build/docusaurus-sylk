...
exports.SylkField = {
    ...
    fromPartial: function (object) {
        ...
        message.extensions = Object.entries((_p = object.extensions) !== null && _p !== void 0 ? _p : {}).reduce(function (acc, _r) {
            var key = _r[0], value = _r[1];
            if (value !== undefined) {
                acc[key] = value;
            }
        ...
        message.oneofFields = ((_q = object.oneofFields) === null || _q === void 0 ? void 0 : _q.map(function (e) { return exports.SylkOneOfField.fromPartial(e); })) || [];
        return message;
    },
};
