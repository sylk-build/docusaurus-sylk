...
var Messages_1 = require("./protos/Messages");
Object.defineProperty(exports, "MessagesClient", { enumerable: true, get: function () { return Messages_1.MessagesClient; } });
var Methods_1 = require("./protos/Methods");
Object.defineProperty(exports, "MethodsClient", { enumerable: true, get: function () { return Methods_1.MethodsClient; } });
var Enums_1 = require("./protos/Enums");
Object.defineProperty(exports, "EnumsClient", { enumerable: true, get: function () { return Enums_1.EnumsClient; } });
var Fields_1 = require("./protos/Fields");
Object.defineProperty(exports, "FieldsClient", { enumerable: true, get: function () { return Fields_1.FieldsClient; } });
var Services_1 = require("./protos/Services");
Object.defineProperty(exports, "ServicesClient", { enumerable: true, get: function () { return Services_1.ServicesClient; } });
var EnumValues_1 = require("./protos/EnumValues");
Object.defineProperty(exports, "EnumValuesClient", { enumerable: true, get: function () { return EnumValues_1.EnumValuesClient; } });
var Sylk = __importStar(require("./protos/Sylk"));
exports.Sylk = Sylk;
var SylkEnum = __importStar(require("./protos/SylkEnum"));
exports.SylkEnum = SylkEnum;
var SylkOrganization = __importStar(require("./protos/SylkOrganization"));
exports.SylkOrganization = SylkOrganization;
var SylkMessage = __importStar(require("./protos/SylkMessage"));
exports.SylkMessage = SylkMessage;
var SylkField = __importStar(require("./protos/SylkField"));
exports.SylkField = SylkField;
var SylkServer = __importStar(require("./protos/SylkServer"));
exports.SylkServer = SylkServer;
var SylkPackage = __importStar(require("./protos/SylkPackage"));
exports.SylkPackage = SylkPackage;
var SylkProject = __importStar(require("./protos/SylkProject"));
exports.SylkProject = SylkProject;
var SylkClient = __importStar(require("./protos/SylkClient"));
exports.SylkClient = SylkClient;
var SylkCommons = __importStar(require("./protos/SylkCommons"));
exports.SylkCommons = SylkCommons;
var SylkConfigs = __importStar(require("./protos/SylkConfigs"));
exports.SylkConfigs = SylkConfigs;
var SylkApi = __importStar(require("./protos/SylkApi"));
exports.SylkApi = SylkApi;
var SylkEnumValue = __importStar(require("./protos/SylkEnumValue"));
exports.SylkEnumValue = SylkEnumValue;
var SylkUser = __importStar(require("./protos/SylkUser"));
exports.SylkUser = SylkUser;
var SylkMethod = __importStar(require("./protos/SylkMethod"));
exports.SylkMethod = SylkMethod;
var SylkService = __importStar(require("./protos/SylkService"));
...
var sylkcore = /** @class */ (function () {
    function sylkcore(host, port, metadata) {
        if (host === void 0) { host = "localhost"; }
        if (port === void 0) { port = 50051; }
        if (metadata === void 0) { metadata = new grpc_js_1.Metadata(); }
        this.host = host;
        this.port = port;
        this.metadata = metadata;
        this.Packages_client = new Packages_1.PackagesClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Projects_client = new Projects_1.ProjectsClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Users_client = new Users_1.UsersClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Organizations_client = new Organizations_1.OrganizationsClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Messages_client = new Messages_1.MessagesClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Methods_client = new Methods_1.MethodsClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Enums_client = new Enums_1.EnumsClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Fields_client = new Fields_1.FieldsClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.Services_client = new Services_1.ServicesClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
        this.EnumValues_client = new EnumValues_1.EnumValuesClient("".concat(this.host, ":").concat(this.port), grpc_js_1.credentials.createInsecure(), _DEFAULT_OPTION);
    }
    sylkcore.prototype.GetPackage = function (request, metadata, callback) {
    ...
    sylkcore.prototype.CreatePackage = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdatePackage = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeletePackage = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.ListPackages = function (request, metadata, callback) {
        var _this = this;
        if (metadata === void 0) { metadata = this.metadata; }
        return new rxjs_1.Observable(function (subscriber) {
            var stream = _this.Packages_client.listPackages(SylkApi.ListPackagesRequest.fromJSON(request), metadata);
    ...
    sylkcore.prototype.GetProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeleteProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.AddUserProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateUserRoleProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateUserStatusProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.RemoveUserProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.ListProjects = function (request, metadata, callback) {
        var _this = this;
        if (metadata === void 0) { metadata = this.metadata; }
        return new rxjs_1.Observable(function (subscriber) {
            var stream = _this.Projects_client.listProjects(SylkApi.ListProjectsRequest.fromJSON(request), metadata);
            stream.on('data', function (res) {
                subscriber.next(res);
            }).on('end', function () {
                subscriber.complete();
    ...
    sylkcore.prototype.CreateProject = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetUser = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateUser = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateUser = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateAccessToken = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetAccessToken = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.ListAccessTokens = function (request, metadata, callback) {
        var _this = this;
        if (metadata === void 0) { metadata = this.metadata; }
        return new rxjs_1.Observable(function (subscriber) {
            var stream = _this.Users_client.listAccessTokens(SylkApi.ListAccessTokensRequest.fromJSON(request), metadata);
            stream.on('data', function (res) {
                subscriber.next(res);
            }).on('end', function () {
                subscriber.complete();
    ...
    sylkcore.prototype.RevokeAccessToken = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetOrganization = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateOrganization = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.ListOrganizations = function (request, metadata, callback) {
        var _this = this;
        if (metadata === void 0) { metadata = this.metadata; }
        return new rxjs_1.Observable(function (subscriber) {
            var stream = _this.Organizations_client.listOrganizations(SylkApi.ListOrganizationsRequest.fromJSON(request), metadata);
            stream.on('data', function (res) {
                subscriber.next(res);
            }).on('end', function () {
                subscriber.complete();
    ...
    sylkcore.prototype.AcceprUserInvite = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.AddUser = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateUserRole = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateUserStatus = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.RemoveUser = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetMessage = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateMessage = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateMessage = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeleteMessage = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetMethod = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateMethod = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateMethod = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeleteMethod = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetEnum = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateEnum = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateEnum = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeleteEnum = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetField = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateField = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateField = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeleteField = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.GetService = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateService = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateService = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeleteService = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.ListServices = function (request, metadata, callback) {
        var _this = this;
        if (metadata === void 0) { metadata = this.metadata; }
        return new rxjs_1.Observable(function (subscriber) {
            var stream = _this.Services_client.listServices(SylkApi.ListServicesRequest.fromJSON(request), metadata);
            stream.on('data', function (res) {
                subscriber.next(res);
            }).on('end', function () {
                subscriber.complete();
    ...
    sylkcore.prototype.GetEnumValue = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.CreateEnumValue = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.UpdateEnumValue = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
    ...
    sylkcore.prototype.DeleteEnumValue = function (request, metadata, callback) {
        if (metadata === void 0) { metadata = this.metadata; }
        if (callback === undefined) {
