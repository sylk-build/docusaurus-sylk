...
exports.FileLink = exports.SylkEnumProto = exports.SylkMessageProto = exports.ProtoService = exports.SylkMethodsProto = exports.SylkMethodProto = void 0;
var react_1 = __importDefault(require("react"));
var Link_1 = __importDefault(require("@docusaurus/Link"));
var react_markdown_1 = __importDefault(require("react-markdown"));
var SylkField_1 = require("../../sylk/protos/sylk/SylkField/v1/SylkField");
...
var SylkProtoMessageFields = function (props) {
    ...
    var getFieldTypeLink = function (field) {
        ...
        return field.fieldType === SylkField_1.SylkFieldTypes.TYPE_MESSAGE
            ? parseNestedTypeLink(field.messageType, packageDep)
            : field.fieldType === SylkField_1.SylkFieldTypes.TYPE_ENUM
    ...
    var FieldsData = function () {
        return (react_1.default.createElement("div", null, fields.map(function (field) {
            ...
            var fieldType = (0, SylkField_1.sylkFieldTypesToJSON)(field.fieldType);
            var displayFieldType = field.fieldType === SylkField_1.SylkFieldTypes.TYPE_MESSAGE ? field.messageType : field.fieldType === SylkField_1.SylkFieldTypes.TYPE_ENUM ? field.enumType : fieldType.split('_')[1].toLocaleLowerCase();
                ...
                react_1.default.createElement("dd", null,
                    react_1.default.createElement("p", null,
                        react_1.default.createElement("span", null,
                            ...
                            ")"),
                        react_1.default.createElement(react_markdown_1.default, null, field.description)))));
        })));
    };
    var FieldRows = function () { return (react_1.default.createElement("pre", null,
        react_1.default.createElement("span", null),
        react_1.default.createElement("span", null, "{"),
        fields.map(function (field) { return (react_1.default.createElement("div", { className: (0, clsx_1.default)('padding-vert--sm') },
            react_1.default.createElement("span", null, " "),
            react_1.default.createElement("span", { className: "sylk-field" },
                "\"",
                field.name,
                "\""),
            ...
            react_1.default.createElement("span", null,
                field.messageType || field.enumType ? react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(Link_1.default, { className: (0, clsx_1.default)('button button--outline button--sm button--primary'), to: getFieldTypeLink(field) },
...
var SylkMessageProto = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { style: { whiteSpace: 'pre-wrap' } },
            react_1.default.createElement(react_markdown_1.default, null, message.description)),
...
var SylkEnumProto = function (props) {
    ...
    var ValueRows = function () { return (react_1.default.createElement(react_1.default.Fragment, null, enumb.values.map(function (enumValue) { return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("dt", { style: styleTitle },
            enumValue.name,
            " - ",
            enumValue.index),
        react_1.default.createElement("dd", null,
            react_1.default.createElement("p", null,
                enumValue.index === 0 ? react_1.default.createElement("span", { style: styleDef },
                    react_1.default.createElement("em", null, "(DEFAULT)")) : '',
                react_1.default.createElement(react_markdown_1.default, null, enumValue.description))))); }))); };
    return (react_1.default.createElement(react_1.default.Fragment, null,
...
var FileLink = function (resource) {
    var fullName = resource.fullName, tag = resource.tag;
    var fileName = tag ? tag : resource.fullName.split('.')[resource.fullName.split('.').length - 2];
    return (react_1.default.createElement(react_1.default.Fragment, null,
