    ...
    return (react_1.default.createElement("table", null,
        react_1.default.createElement("tbody", null,
            ...
            react_1.default.createElement("tr", null,
                ...
                react_1.default.createElement("td", null,
                    react_1.default.createElement(Link_1.default, { to: method.inputType },
            ...
            react_1.default.createElement("tr", null,
                ...
                react_1.default.createElement("td", null,
                    react_1.default.createElement(Link_1.default, { to: method.outputType },
...
var ProtoServiceMethods = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, methods.map(function (method, i) { return (react_1.default.createElement(exports.ProtoServiceMethod, { method: method, key: "".concat(method.name, "-").concat(i) })); })));
};
...
var SylkProject = function (props) {
    var _a, _b;
    var fileDescriptor = props.fileDescriptor, components = props.components;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(components.h1, null, fileDescriptor.resource.name),
        react_1.default.createElement("p", { style: { whiteSpace: 'pre-wrap' } }, fileDescriptor.resource.description), (_b = (_a = fileDescriptor.resource) === null || _a === void 0 ? void 0 : _a.messages) === null || _b === void 0 ? void 0 :
        _b.map(function (message, i) { return (react_1.default.createElement(exports.ProtoMessage, { message: message, key: i })); })));
};
exports.default = SylkProject;
