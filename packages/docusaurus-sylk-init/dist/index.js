    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (options) {
                ...
                options.sylkJsonsPaths.forEach(function (sylkJson) {
            ...
            jsonsToServe.forEach(function (sylkJson) {
                ...
                fs_1.default.mkdirSync("".concat(siteName, "/sylk/").concat(prjName));
            });
            if (json) {
                fs_1.default.copyFileSync(options.json, "".concat(siteName, "/sylk/").concat(json.project.name, "/sylk.json"));
            }
